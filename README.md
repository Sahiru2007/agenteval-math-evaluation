...
You can reuse or adapt these in your resume:

- Adapted Microsoft AutoGen's AgentEval workflow to evaluate a math-solving LLM agent using rubric-based criteria instead of binary correctness alone.
- Built a Python/Jupyter evaluation pipeline that generated task-specific criteria, quantified agent outputs, batch-scored logged samples, and visualized performance with confidence intervals.
- Presented LLM evaluation results through recruiter-friendly documentation and visual assets, highlighting strengths and weaknesses across reasoning quality, correctness, clarity, and efficiency.
...
**Short description:**  
Portfolio project showing rubric-based evaluation of an LLM math-solving agent with AutoGen AgentEval, Python, and visualization.

**Suggested topics/tags:**  
`llm-evaluation`, `autogen`, `agenteval`, `ai-agents`, `python`, `jupyter-notebook`, `matplotlib`, `machine-learning`, `prompt-evaluation`, `math-reasoning`

---

## What to improve next

To make this repository even stronger, you could add:

- a `requirements.txt`
- a small `results/` folder for saved JSON outputs
- a cleaned sample dataset bundled directly in the repo
- a notebook-to-script conversion for reproducibility
- comparison between multiple models or prompting strategies
- richer dashboards beyond static matplotlib charts

---

## Important note on attribution

This project is **adapted from Microsoft AutoGen's AgentEval ecosystem** and repurposed here for a math problem-solving evaluation scenario. The portfolio value comes from the adaptation, framing, organization, analysis flow, and presentation of the work.

---

## License / usage

If you publish this project, make sure attribution and licensing remain aligned with the upstream framework and any sample assets you keep from the original source.

---

## Contact / portfolio usage

This repository is suitable for:

- GitHub portfolio presentation
- internship applications
- ML / AI / software engineering resumes
- technical interviews discussing LLM evaluation
- showcasing experiment design and analysis skills
